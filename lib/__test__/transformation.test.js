...
test("rotating a point around the x axis", () => {
  ...
  expect(
    halfQuarter
      .mul(p)
      .equals(point(0, Math.sqrt(2) / 2, Math.sqrt(2) / 2), 0.00001)
  ).toBe(true);
...
test("the inverse of an x-rotation rotates in the opposite direction", () => {
  ...
  expect(
    inv.mul(v).equals(point(0, Math.sqrt(2) / 2, -Math.sqrt(2) / 2), 0.00001)
  ).toBe(true);
});
...
test("rotating a point around the y axis", () => {
  ...
  expect(
    halfQuarter
      .mul(p)
      .equals(point(Math.sqrt(2) / 2, 0, Math.sqrt(2) / 2), 0.00001)
  ).toBe(true);
...
test("rotating a point around the z axis", () => {
  ...
  expect(
    halfQuarter
      .mul(p)
      .equals(point(-Math.sqrt(2) / 2, Math.sqrt(2) / 2, 0), 0.00001)
  ).toBe(true);
